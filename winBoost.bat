...
:: Option names
set options_1=Network Optimization
set options_2=CPU Optimization
set options_3=GPU Optimization
set options_4=SSD Optimization
set options_5=Telemetry Reduction
set options_6=UWP App Cleanup
set options_7=Disable Unnecessary Services
set options_8=Remove Cortana/OneDrive/Bing
set options_9=Advanced System Cleaning
set options_10=Ad/Tracker Host Blocking

:main_menu
cls
echo ===============================
echo   Windows 11 Ultra Optimizer
echo ===============================
echo.
...
call set val=%%%var%%%
if "!val!"=="1" (
    echo [%idx%] [X] !options_%idx%!
) else (
    echo [%idx%] [ ] !options_%idx%!
)
endlocal & exit /b
